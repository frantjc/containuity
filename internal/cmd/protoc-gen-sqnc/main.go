...
//
//      https://github.com/bufbuild/buf/cmd/buf/main.go
//
// To generate Services and Messages in the same
// proto package in the same Go package to avoid
// an import cycle it caused for sequence's
// particular use-case.
...
func generate(plugin *protogen.Plugin, file *protogen.File) {
	...
	generatedFile := plugin.NewGeneratedFile(
		...
		protogen.GoImportPath(string(file.GoImportPath)),
	)
